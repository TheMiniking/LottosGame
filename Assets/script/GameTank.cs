...
public class GameTank : MonoBehaviour
{
    ...
    [SerializeField] TMP_Text betButtonTxt,betValTex,autoStopTxt,winnersFromRoundTxt, roundTxt;             //texto do botao de aposta, total a apostar e onde parar
        ...
        {   
            if (onMove && countdown<0)
            {
                ...
                if (flameCount % 20 == 0)
                {
                    ...
                    var r = UnityEngine.Random.Range(1, 20);
                    if (r == 1) InstantiateBox();
                }
