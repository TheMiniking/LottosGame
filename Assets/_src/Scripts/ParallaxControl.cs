...
public class ParallaxControl : MonoBehaviour
{
    ...
    void PlayAnim()
    {
       tween = Tween.Custom(image, image.uvRect.x, image.uvRect.x + 1, velocity, (t, x) => image.uvRect = new Rect(x, image.uvRect.y, image.uvRect.width, image.uvRect.height), Ease.Linear,cycleMode: CycleMode.Restart);
    }
}
