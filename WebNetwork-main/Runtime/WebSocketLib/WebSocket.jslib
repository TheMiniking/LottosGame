...
var LibraryWebSocket = {
  ...
  WebSocketAddSubProtocol: function(instanceId, subprotocol) {
	...
	WebSocketConnect: function(instanceId) {
		...
		var instance = webSocketState.instances[instanceId];
		if (!instance){
			console.log("WebSocketConnect return -1");
			return -1;
		}
		if (instance.ws !== null){
			console.log("WebSocketConnect return -2");
			return -2;
		}
		...
		instance.ws.onclose = function(ev) {
			...
			instance.ws.close();
			instance.ws = null; // Set the reference to null
	...
	WebSocketClose: function(instanceId, code, reasonPtr) {
		...
		var instance = webSocketState.instances[instanceId];
		console.log("WebSocketClose Closed. ");
		if (!instance){
		console.log("WebSocketClose Closed. instance false");
		return -1;
		}

		if (!instance.ws){
			console.log("WebSocketClose Closed. instance.ws false");
			return -3;
			}

		if (instance.ws.readyState === 2){
			console.log("WebSocketClose Closed. instance.ws.readyState = 2");
			return -4;
			}

		if (instance.ws.readyState === 3){
			console.log("WebSocketClose Closed. instance.ws.readyState = 3");
			return -5;
			}
		...
		try {
			...
			console.log("WebSocketClose Closed. return -7");
			return -7;
		}
